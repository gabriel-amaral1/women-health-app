...
import 'package:women_health_app/screens/Question7.dart';


class Question6 extends StatefulWidget {
  final symptomatology, name, cpf, address, healthUnitRecord, susCard;
  Question6(this.symptomatology, this.name, this.cpf, this.address, this.healthUnitRecord, this.susCard);
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Center(
          child: Column(
            children: [
              methods.questionFont("Sente dor durante as relações sexuais?"),
              Padding(
      ...
      floatingActionButton: Padding(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            methods.helpFloatingActionButton("helpSexualRelations"),
            methods.nextQuestionFloatingActionButton(context, "sexualRelationsQuestion", widget.symptomatology, "Dor Relações Sexuais", Question7(widget.symptomatology, widget.name, widget.cpf, widget.address, widget.healthUnitRecord, widget.susCard), answer),
          ],
        ),
      )
    );
